...
// El diagnóstico funcional CIF ya no es una sección más del acordeón: es un popup
// con el diagrama biopsicosocial de la CIF (ver secCIFTrigger/cifModalHTML en cif.js).
